...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('essential', '0008_remove_product_image'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='essential.product')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('items', models.ManyToManyField(to='essential.orderitem')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
